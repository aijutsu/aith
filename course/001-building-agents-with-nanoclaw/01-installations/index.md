...
1. Optional: a Claude Pro plan or higher, if you want to use [Claude Code](./08-claude-code/index.md) as your helper instead of Codex.
...
| [Homebrew](./02-homebrew/index.md) **(macOS and Linux)** | An app store for the terminal. On Windows it goes inside Ubuntu. | Installing most of the tools below with one short command each. |
| [Chocolatey](./03-chocolatey/index.md) **(Windows only)** | The same thing for Windows itself. | Installing Docker Desktop. Skip this page on macOS and Linux. |
...
| [Codex](./07-codex/index.md) | OpenAI's AI helper for the terminal. | The part of your agent that thinks. It also helps you set NanoClaw up and change it later. |
| [Claude Code](./08-claude-code/index.md) **(optional)** | Anthropic's AI helper for the terminal. | Nothing you must do. Install it only if you have a Claude plan and would rather use Claude than Codex as your helper. |

## How the pages work

- **Do them in order.** Each page builds on the one before it. The app store you install on page 2 or 3 is what installs almost everything after it.
...
- **Two pages are for one system only**, and their titles say so: Homebrew on macOS and Linux (and inside Ubuntu on Windows), Chocolatey on Windows. Do the one for your computer and skip the other.
