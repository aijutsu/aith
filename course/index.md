...
1. Building personal websites
    ...
    1. Introduces basic static deployments with Github, Cloudflare, and Wrangler
...
1. Building agentic workflows
    ...
    1. Introduces non-relational databases (MongoDB) and file storage (Cloudflare R2) for data storage
    1. Introduces MCP servers as a way to interact with services 
